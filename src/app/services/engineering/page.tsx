        ...
        <div className="max-w-7xl mx-auto px-6 py-24 md:py-32 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            <div className="relative w-full h-full rounded-full overflow-hidden border border-red-600/30 shadow-2xl">
              <Image
                src="/images/engineering-hero.jpg"
                alt="Civil and Structural Engineering Services"
                fill
                priority
                className="object-cover"
              />
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16">
          ...
          >
            ...
            <p className="text-neutral-600 leading-relaxed">
              Our engineering team delivers technically sound solutions that
              integrate seamlessly with architectural design and construction
              execution. Every decision is informed by safety, efficiency, and
              compliance.
            </p>
          </motion.div>
          ...
          >
            <p className="text-neutral-600 leading-relaxed">
              We analyze site conditions, materials, loads, and regulations to
              mitigate risk and ensure durability across the entire lifecycle
              of the project.
            </p>
          </motion.div>
      ...
      <section className="py-28 bg-black text-white text-center">
        ...
        >
          ...
          <p className="text-gray-400 mb-10 max-w-xl mx-auto">
            Partner with our engineering team to ensure your project is safe,
            compliant, and built to last.
          </p>

          <a
            href="https://wa.me/254703204119?text=Hello%2C%20I%20would%20like%20to%20discuss%20engineering%20services."
            target="_blank"
...
const capabilities = [
  {
    ...
    description:
      "Infrastructure and site engineering for residential and commercial projects.",
    icon: Network,
  },
  {
    title: "Structural Engineering",
    description:
      "Load analysis, foundation design, and structural integrity planning.",
    icon: DraftingCompass,
  },
  {
    title: "Risk & Safety Analysis",
    description:
      "Engineering assessments to minimize structural and operational risks.",
    icon: ShieldCheck,
  },
  {
    title: "Systems Coordination",
    description:
      "Integrated coordination across disciplines to avoid conflicts during construction.",
    icon: Settings,
  },
];
